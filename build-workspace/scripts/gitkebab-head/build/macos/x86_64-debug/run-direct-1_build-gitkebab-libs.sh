...
define_basic_variables "gitkebab-head" "macos" "x86_64" "debug"
...
LIBGIT2_DIR=build/libgit2-1.4.0/${TARGET_FOLDER_TRIPLET}
LIBICONV_DIR=build/libiconv-1.16/${TARGET_FOLDER_TRIPLET}
