...
define_basic_variables "libgit2-1.1.1" "windows" "x86_64" "debug"
...
MMOZEIKO_MINGW_WINSOCK_LIB=/usr/local/x86_64-w64-mingw32/lib/libwsock32.a
MMOZEIKO_MINGW_CRYPT32_LIB=/usr/local/x86_64-w64-mingw32/lib/libcrypt32.a
MMOZEIKO_MINGW_WS2_32_LIB=/usr/local/x86_64-w64-mingw32/lib/libws2_32.a
...
DLLTOOL=x86_64-w64-mingw32-dlltool cmake ${RELATIVE_SOURCE} \
      ...
      -DLIBGIT2_CLAR_EXTRA_LIBS="${OPENSSL_LIB};${CRYPTO_LIB};${MMOZEIKO_MINGW_WINSOCK_LIB};${MMOZEIKO_MINGW_CRYPT32_LIB};${MMOZEIKO_MINGW_WS2_32_LIB}" \
      -DENABLE_TRACE=ON \
      -DCMAKE_POSITION_INDEPENDENT_CODE=ON 
