...
typedef enum gk_repository_state {
    ...
    GK_REPOSITORY_STATE_INITIALIZED                = (1 << 0),
    GK_REPOSITORY_STATE_LOCAL_CHECKOUT_EXISTS      = (1 << 1),
    GK_REPOSITORY_STATE_HAS_CONFLICTS              = (1 << 2),
    GK_REPOSITORY_STATE_HAS_CHANGES_TO_COMMIT      = (1 << 3),
    GK_REPOSITORY_STATE_HAS_CHANGES_TO_MERGE       = (1 << 4),
    GK_REPOSITORY_STATE_CLONE_IN_PROGRESS          = (1 << 5),
    GK_REPOSITORY_STATE_MERGE_FINALIZATION_PENDING = (1 << 6),
    GK_REPOSITORY_STATE_MERGE_PENDING_ON_DISK      = (1 << 7),
    GK_REPOSITORY_STATE_PUSH_IN_PROGRESS           = (1 << 8),
    GK_REPOSITORY_STATE_FETCH_IN_PROGRESS          = (1 << 9),
    GK_REPOSITORY_STATE_MERGE_IN_PROGRESS          = (1 << 10),
} gk_repository_state;
