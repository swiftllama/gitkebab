...
typedef enum gk_repository_verify_condition {
    ...
    GK_REPOSITORY_VERIFY_MERGE_INDEX_LOADED = (1 << 5)
...
typedef enum gk_repository_state {
    ...
    GK_REPOSITORY_STATE_HAS_CHANGES_TO_COMMIT      = (1 << 2),
    GK_REPOSITORY_STATE_HAS_CHANGES_TO_MERGE       = (1 << 3),
    GK_REPOSITORY_STATE_CLONE_IN_PROGRESS          = (1 << 4),
    GK_REPOSITORY_STATE_MERGE_FINALIZATION_PENDING = (1 << 5),
    GK_REPOSITORY_STATE_MERGE_PENDING_ON_DISK      = (1 << 6),
    GK_REPOSITORY_STATE_PUSH_IN_PROGRESS           = (1 << 7),
    GK_REPOSITORY_STATE_FETCH_IN_PROGRESS          = (1 << 8),
    GK_REPOSITORY_STATE_MERGE_IN_PROGRESS          = (1 << 9),
} gk_repository_state;

#define GK_REPOSITORY_STATE_MAX_EXP 10
