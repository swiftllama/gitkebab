...
class GitKebabLib {
  ...
  void gk_session_progress_update(
    ffi.Pointer<gk_session> session,
    ffi.Pointer<gk_session_progress> progress,
  ) {
    return _gk_session_progress_update(
      session,
      progress,
    );
  }

  late final _gk_session_progress_update_ptr =
      _lookup<ffi.NativeFunction<_c_gk_session_progress_update>>(
          'gk_session_progress_update');
  late final _dart_gk_session_progress_update _gk_session_progress_update =
      _gk_session_progress_update_ptr
          .asFunction<_dart_gk_session_progress_update>();
  ...
  int gk_session_state_lock(
    ...
    return _gk_session_state_lock(
      session,
    );
  }

  late final _gk_session_state_lock_ptr =
      _lookup<ffi.NativeFunction<_c_gk_session_state_lock>>(
          'gk_session_state_lock');
  late final _dart_gk_session_state_lock _gk_session_state_lock =
      _gk_session_state_lock_ptr.asFunction<_dart_gk_session_state_lock>();

  int gk_session_state_unlock(
    ffi.Pointer<gk_session> session,
  ) {
    return _gk_session_state_unlock(
      session,
    );
  }

  late final _gk_session_state_unlock_ptr =
      _lookup<ffi.NativeFunction<_c_gk_session_state_unlock>>(
          'gk_session_state_unlock');
  late final _dart_gk_session_state_unlock _gk_session_state_unlock =
      _gk_session_state_unlock_ptr.asFunction<_dart_gk_session_state_unlock>();
...
abstract class RepositoryState {
  ...
  static const int BACKGROUND_SYNC_IN_PROGRESS = 4096;
}
...
class gk_session extends ffi.Struct {
  ...
  external ffi.Pointer<gk_session_progress> progress;

  external ffi.Pointer<ffi.Void> state_lock;
...
const int GK_REPOSITORY_STATE_MAX_EXP = 13;
...
typedef _c_gk_session_progress_update = ffi.Void Function(
  ffi.Pointer<gk_session> session,
  ffi.Pointer<gk_session_progress> progress,
);

typedef _dart_gk_session_progress_update = void Function(
  ffi.Pointer<gk_session> session,
  ffi.Pointer<gk_session_progress> progress,
);
...
typedef _dart_gk_session_state_lock = int Function(
  ffi.Pointer<gk_session> session,
);

typedef _c_gk_session_state_unlock = ffi.Int32 Function(
  ffi.Pointer<gk_session> session,
);

typedef _dart_gk_session_state_unlock = int Function(
  ffi.Pointer<gk_session> session,
);
